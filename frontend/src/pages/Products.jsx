...
const Products = () => {
  ...
  const filteredAndSortedProducts = useMemo(() => {
    ...
    result.sort((a, b) => {
      ...
      if (['stock_quantity', 'sale_price', 'purchase_price', 'purchase_price_without_vat'].includes(sortField)) {
  ...
  // Eski filteredProducts yerine paginatedProducts kullan
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-between px-4 py-3 border-t">
            <div className="text-sm text-muted-foreground">
              Toplam {filteredAndSortedProducts.length} üründen {((currentPage - 1) * itemsPerPage) + 1}-{Math.min(currentPage * itemsPerPage, filteredAndSortedProducts.length)} gösteriliyor
            </div>
            <div className="flex items-center gap-2">
              <Button
                variant="outline"
